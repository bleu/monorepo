...
export const getBALPriceByRound = async (round: Round) => {
  return getTokenPriceByRound(round, '0xba100000625a3754423978a60c9317c58a424e3d', 1);
};

export const getTokenPriceByRound = async (round: Round, tokenAddress: string, tokenNetwork: number) => {
