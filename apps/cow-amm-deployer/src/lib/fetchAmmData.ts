...
export const getAmmData = async (
  subgraphData: ICoWAMMSubgraph,
): Promise<ICowAmm> => {
...
export const fetchAmmData = async (ammId: string): Promise<ICowAmm> => {
...
export const fetchUserAmmsData = async (userId: string): Promise<ICowAmm[]> => {
