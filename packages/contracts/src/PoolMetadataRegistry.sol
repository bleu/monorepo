...
contract PoolMetadataRegistry is IPoolMetadataRegistry, PoolMetadataAuthorization {
    ...
    constructor(IVault vault) PoolMetadataAuthentication(bytes32(uint256(address(this)))) PoolMetadataAuthorization() {
        _vault = vault;
    }
    ...
    function _getOwner(bytes32 poolId) internal view override returns (address) {
