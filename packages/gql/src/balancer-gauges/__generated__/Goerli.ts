...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...
    usePreferentialGauge(variables?: PreferentialGaugeQueryVariables, config?: SWRConfigInterface<PreferentialGaugeQuery, ClientError>) {
      return useSWR<PreferentialGaugeQuery, ClientError>(genKey<PreferentialGaugeQueryVariables>('PreferentialGauge', variables), () => sdk.PreferentialGauge(variables), config);
    },
    usePoolPreferentialGauge(variables: PoolPreferentialGaugeQueryVariables, config?: SWRConfigInterface<PoolPreferentialGaugeQuery, ClientError>) {
      return useSWR<PoolPreferentialGaugeQuery, ClientError>(genKey<PoolPreferentialGaugeQueryVariables>('PoolPreferentialGauge', variables), () => sdk.PoolPreferentialGauge(variables), config);
    }
  };
}
