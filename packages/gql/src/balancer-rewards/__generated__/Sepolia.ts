...
export type Query = {
  ...
  rewardTokenDeposit?: Maybe<RewardTokenDeposit>;
  rewardTokenDeposits: Array<RewardTokenDeposit>;
...
export type QueryRewardTokenDepositArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID']['input'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type QueryRewardTokenDepositsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<RewardTokenDeposit_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
  skip?: InputMaybe<Scalars['Int']['input']>;
  subgraphError?: _SubgraphErrorPolicy_;
  where?: InputMaybe<RewardTokenDeposit_Filter>;
};
...
export type RewardTokenDeposit = {
  __typename?: 'RewardTokenDeposit';
  /**  Reference to LiquidityGauge entity  */
  gauge: LiquidityGauge;
  /**  Equal to: <tokenAddress>-<gaugeAddress>-<periodFinish>  */
  id: Scalars['ID']['output'];
  /**  Timestamp at which finishes the period of rewards  */
  periodFinish?: Maybe<Scalars['BigInt']['output']>;
  /**  Timestamp at which starts the period of rewards  */
  periodStart?: Maybe<Scalars['BigInt']['output']>;
  /**  Rate of reward tokens streamed per second  */
  rate?: Maybe<Scalars['BigDecimal']['output']>;
  /**  Reference to RewardToken entity  */
  token: RewardToken;
};

export type RewardTokenDeposit_Filter = {
  /** Filter for the block changed event. */
  _change_block?: InputMaybe<BlockChangedFilter>;
  and?: InputMaybe<Array<InputMaybe<RewardTokenDeposit_Filter>>>;
  gauge?: InputMaybe<Scalars['String']['input']>;
  gauge_?: InputMaybe<LiquidityGauge_Filter>;
  gauge_contains?: InputMaybe<Scalars['String']['input']>;
  gauge_contains_nocase?: InputMaybe<Scalars['String']['input']>;
  ...
  id_not?: InputMaybe<Scalars['ID']['input']>;
  id_not_in?: InputMaybe<Array<Scalars['ID']['input']>>;
  or?: InputMaybe<Array<InputMaybe<RewardTokenDeposit_Filter>>>;
  ...
  token_?: InputMaybe<RewardToken_Filter>;
...
export type RewardTokenDeposit_OrderBy =
  | 'gauge'
  | 'gauge__id'
  | 'gauge__isKilled'
  | 'gauge__isPreferentialGauge'
...
export type SubscriptionRewardTokenDepositArgs = {
  block?: InputMaybe<Block_Height>;
  id: Scalars['ID']['input'];
  subgraphError?: _SubgraphErrorPolicy_;
};
...
export type SubscriptionRewardTokenDepositsArgs = {
  block?: InputMaybe<Block_Height>;
  first?: InputMaybe<Scalars['Int']['input']>;
  orderBy?: InputMaybe<RewardTokenDeposit_OrderBy>;
  orderDirection?: InputMaybe<OrderDirection>;
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    PoolRewards(variables: PoolRewardsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<PoolRewardsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<PoolRewardsQuery>(PoolRewardsDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'PoolRewards', 'query');
    }
  };
}
...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    usePoolRewards(variables: PoolRewardsQueryVariables, config?: SWRConfigInterface<PoolRewardsQuery, ClientError>) {
      return useSWR<PoolRewardsQuery, ClientError>(genKey<PoolRewardsQueryVariables>('PoolRewards', variables), () => sdk.PoolRewards(variables), config);
    }
  };
}
