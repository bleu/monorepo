...
import { ENDPOINTS, Network } from "@balancer-pool-metadata/balancer-gql/codegen";
...
const currentNetwork = typeof localStorage !== "undefined" ? localStorage.getItem('networkId') ?? "1" : "1"
...
const client = new GraphQLClient(
  ENDPOINTS[networkFor(currentNetwork)]
);
